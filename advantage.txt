...
def compute_group_advantages(
    ...
    for r in rewards:
        ...
        # NOTE: rank_normalize is disabled because it breaks the advantage signal
        # when all rewards are identical (all 0 or all 1). The variance normalization
        # (step 2) is sufficient for stability. Rank normalization converts advantages
        # to rank positions, which destroys the zero-advantage property needed for
        # groups with uniform rewards.
        # if rank_normalize:
